...
class get_model(nn.Module):
    def __init__(self):
        ...
        self.pd_mask_2 = nn.Conv1d(32,2,1)
    ...
    def forward(self, xyz):
        ...
        pd_1 = self.pd_mask_1(l0_points_0)
        weight_1 = self.wt_mask_1(l0_points_0)

        l0_points_1 = torch.cat([l0_points_0, pd_1],dim=1)
        l0_xyz_1 = xyz[:,:3,:]
        ...
        _, num_pred = self.flatten_sa(l3_xyz_1, l3_points_1)
        num_pred = num_pred.view(B, 512)
        num_pred = F.relu(self.bn1(self.fc1(num_pred)))
        num_pred = self.fc2(num_pred)

        pd_2 = self.pd_mask_2(l0_points_1)
        
        return pd_1, weight_1, pd_2, num_pred
...
if __name__ == '__main__':
    ...
    xyz = torch.rand(15, 20, 4096).cuda()
